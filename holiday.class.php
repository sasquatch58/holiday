...
class CHoliday extends w2p_Core_BaseObject
{
    ...
    public function loadFull(w2p_Core_CAppUI $AppUI, $holidayId)
    {
    ...
    public function remove(w2p_Core_CAppUI $AppUI, w2p_Utilities_Date $date)
    {
        $perms = $AppUI->acl();
        $removed = false;
        if ($this->holiday_id && $perms->checkModuleItem('holiday', 'edit', $this->holiday_id)) {
    ...
    public function getCalendarLink(w2p_Core_CAppUI $AppUI, $item)
    {
